...
import TextIconButton from "@/app/components/Button";
...
export default function Home() {
    return (
        <main className="w-full h-screen text-off-white inline-flex flex-col items-center justify-center gap-y-4">
            <Image
